setwd("C:/Users/davin/Documents/PhD/Writing/Heterogeneity/Supp_Data/Tool_promoter_platecurver/140623_rep1_rep2/")
library(readxl)
...
sortfiles<-mixedsort(list.files(pattern = '140623_t'))
sortfiles


#tidy up function - REMEMBER TO CHANGE TIME POINTS
tidy.up<-function(newseries){
  Time<-c("0","2","2.5","4","5","6","7","8","9","10","11","24.17","25","25.5",
          "26.33","27","31","32","48","49","50","51","52","53","54")
  tns<-t(newseries)
